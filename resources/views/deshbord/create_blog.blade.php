        ...
        <div class="col-6 offset-md-3">
            ...
            <form method="post" action="/create-blog" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="heading" value="{{ old('heading') }}" class="@error('heading') is-invalid @enderror form-control" id="heading" placeholder="Enter heading" aria-describedby="emailHelp">
                    @error('heading')
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control @error('blog_content') is-invalid @enderror" name="blog_content" id="blog_content" placeholder="Write your blog_content here.." rows="3">{{ old('blog_content') }}</textarea>
                    @error('blog_content')
                    <small id="emailHelp" class="form-text text-danger">{{ $message }}</small>
                    @enderror
                </div>
